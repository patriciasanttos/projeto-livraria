...
function HomePage() {
  ...
  const category2 = categoriesData && categoriesData.length > 1 ? categoriesData[1] : mock.data[1];
  const category3 = categoriesData && categoriesData.length > 2 ? categoriesData[2] : mock.data[2] || mock.data[0];
